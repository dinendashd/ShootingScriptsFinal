        ...
        if (Physics.Raycast(ray, out RaycastHit hit, MaxDistance))
        {
            if (hit.collider.CompareTag("Item"))
            {
                ...
                if (hit.collider.GetComponentInChildren<SOGunControlsYt>() != null)
                {
                    ...
                    recoilControls.recoilUpAmount = sOGunControlsYt.gunVariables.recoilUpDistance;

                    recoilControls.recoilLeftAmountmin = sOGunControlsYt.gunVariables.recoilLeftAmountmin;
                    recoilControls.recoilLeftAmountmax = sOGunControlsYt.gunVariables.recoilLeftAmountmax;
                    recoilControls.recoilRightAmountMin = sOGunControlsYt.gunVariables.recoilRightAmountMin;
                    recoilControls.recoilRightAmountMax = sOGunControlsYt.gunVariables.recoilRightAmountMax;
